    ...
    <Shell>
      <main>
        ...
        <section className="section">
          ...
          <div className="grid">
            {[
              "ищет вакансии через HTML-страницы hh.ru",
  ...
  return (
    <Shell>
      <main className="document">
        ...
        <p>
          Проект может обрабатывать данные вакансий, полученные со страниц hh.ru: название, компанию, ссылку,
        ...
        <p>
          Сессионные cookie и другие секреты не должны храниться в публичном коде. Cookie используются только для личного запуска JobRadar.
        </p>
        <p>{contactText}</p>
      </main>
    </Shell>
  ...
  return (
    <Shell>
      <main className="document">
        ...
        <p>
          Результаты поиска зависят от доступности hh.ru, параметров поиска, качества вакансий и настроек
          фильтрации.
        </p>
